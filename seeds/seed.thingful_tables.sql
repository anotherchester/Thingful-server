...
VALUES
  ('dunder', 'Dunder Mifflin', null, '$2a$12$cOMbgaMwo9PoLiPkvyI7wObVaL8r/giyVCOllozpS0BNAp0BXZRUy'), --'password'
  ('b.deboop', 'Bodeep Deboop', 'Bo', '$2a$12$cnwLQnvW/QTcAN/t.Kr5D.dl0OF0SedVdisasNtsooNOubPXnQUku'), --'bo-password'
  ('c.bloggs', 'Charlie Bloggs', 'Charlie', '$2a$12$t73iFxPkl220pVBkES/2nuHCwiMobh5WNgiW.2O2Ao/RRl10PBEke'), --'charlie-password'
  ('s.smith', 'Sam Smith', 'Sam', '$2a$12$klc9KiYF8GcgEM3p0dUA.OeoL0CkXwRNGy7lPUjr.mhsz.mCmH9eG'), --'sam-password'
